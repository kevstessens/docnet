    ...
    <div class="main">
        ...
        <article id="content"/>
            <div class="wrapper tabs">
                <div id="tab1">
                    <h5><span class="dropcap"><strong>.</strong><span></span></span>Modificá un usuario:</h5>
                    <c:if test="${error != null}">
                        <c:out value="No existe ningún usuario con el mail: ${error}"/>
                    </c:if>
                </div>
                <form method="post" action="ModificarServlet">
                    <table class="Box">
                        <tr>
                            <td>Email de usuario a modificar:</td>
                            <td><input name="email" type="email" placeholder="Ingresá el email">
                            </td>
                        </tr>
                        <tr>
                            <td> Los campos no ingresados permanecerán sin modificar.</td>
                        </tr>
                        <tr>
                            <td>Nuevo nombre :</td>
                        ...
                        <tr>
                            <td>Nueva fecha de nacimiento :</td>
                            <td><input name="fechaDeNacimiento" placeholder="DD/MM/AAAA">
                            </td>
                        </tr>
                        <tr>
                            <td>Nueva obra social :</td>
                            <td><select name="obraSocial">
                                <option>ObraSocial A</option>
                                <option>ObraSocial B</option>
                                <option>ObraSocial C</option>
                                <option>ObraSocial D</option>
                            </select>
                            </td>
                        </tr>
                    </table>

                    <input type="submit" class="button" value="Modificar" align="center">
                </form>
            </div>

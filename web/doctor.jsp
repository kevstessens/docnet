            ...
            <div class="wrapper">
                <section class="col1">
                    ...
                    <%
                        ...
                        Doctor doctor = (Doctor) UsuarioDAO.getUsuarioPorEmailInSession(email);
                        s.setAttribute("doctor", doctor);
                        s.setAttribute("DNI", doctor.getDNI());
                        s.setAttribute("isDoctor", "Si");
                    %>
                    <form id="ContactForm" method="post">
                        <span><a href="CalendarServlet" class="button">Ver calendario</a></span>
                    </form>

            ...
            <div class="wrapper">
                <section class="col1">
                    ...
                    <form id="ContactForm" method="post">
                        ...
                        <span><a href="agregarDoctor.jsp" class="button">Agregar Doctor</a></span>
                        <span><a href="modificar.jsp" class="button">Modificar Usuarios</a></span>
                        <span><a href="eliminar.jsp" class="button">Eliminar Usuarios</a></span>

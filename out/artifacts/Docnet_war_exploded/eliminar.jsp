    ...
    <div class="main">
        ...
        <article id="content"/>
            <div class="wrapper tabs">
                <div id="tab1">
                    <h5><span class="dropcap"><strong>.</strong><span></span></span>Eliminá un usuario:</h5>
                ...
                <form method="post" action="EliminarServlet">
                    <table class="Box">
                        <tr>
                            <td>Email de usuario a eliminar:</td>
                            <td><input name="email" type="email" placeholder="Ingresá el email">
                            </td>
                        </tr>
                    </table>

                    <input type="submit" class="button" value="Eliminar" align="center">
                </form>
            </div>
